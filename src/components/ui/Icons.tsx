...
export const WrenchIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const RotateCwIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const PuzzleIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const HeartIcon: React.FC<HeartIconProps> = ({ size = 24, filled = false, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const SnowflakeIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const CloudIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        ...
        {...props}
    >
        <path d="M17.5 19c0-1.7-1.3-3-3-3h-1.6c-.2-3.1-2.9-5.5-6-5.5a6 6 0 0 0 0 12h10.6a2.9 2.9 0 0 0 0-5.8Z" />
    </svg>
);
...
export const BookmarkIcon: React.FC<HeartIconProps> = ({ size = 24, filled = false, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const HashIcon: React.FC<IconProps> = ({ size = 24, ...props }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
